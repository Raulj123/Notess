<h1 style="font:bold; text-align:center;">Welcome to Notess a Note-taking web application that enables users to securely create accounts, store notes, and access and edit them whenever they 
want</h1> 
